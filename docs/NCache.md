...
#### 参数
+ cfg *&lt;<font class='datatype'>[CacheCfg](/webroute/api/CacheCfg)</font>&gt;*   cache初始化参数
...
<font class="since">开始于:v0.0.1</font>  
修饰符: <font class="modifier">private  async</font>  
#### 描述
存到值redis  
#### 参数
+ item *&lt;<font class='datatype'>[CacheItem](/webroute/api/CacheItem)</font>&gt;*      cache item
...
添加值到cache  
#### 参数
+ item *&lt;<font class='datatype'>[CacheItem](/webroute/api/CacheItem)</font>&gt;* 
