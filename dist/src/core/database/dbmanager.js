...
const mongoconnectionmanager_1 = require("./mongoconnectionmanager");
        ...
        if (!cm && product) {
            ...
            switch (product) {
                ...
                case "oracle":
                    ...
                    break;
                case "mongodb":
                    cm = new mongoconnectionmanager_1.MongoConnectionManager(opt);
                    instancefactory_1.InstanceFactory.addInstance({
                        name: cmName,
                        instance: cm,
                        class: mongoconnectionmanager_1.MongoConnectionManager
                    });
                    break;
                case "sequelize":
                ...
                case "typeorm":
                    ...
                    instancefactory_1.InstanceFactory.addInstance({
                        name: cmName,
                        instance: cm,
                        class: typeormconnectionmanager_1.TypeormConnectionManager
                    });
                    break;
            }
        }
